# 10M Records, 27 Minutes, 4 CLI Commands
...
Mass Migrator v3 takes the opposite bet.
...
**Total: 27 minutes.** Verified row counts, balance sums, enrichment coverage, partition spread.
...
**→ github.com/massmigrator/mass-migrator**

---

*Published 2026-06-01. Based on the simple-mode test in `tests/test-6step-simple-mode-go.sh`. Per-mode timings extrapolated from the 50K-record default test against 8-thread / 5K-batch hardware baselines; real numbers will vary ±20% depending on disk, network, and target schema complexity.*
